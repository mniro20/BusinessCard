...
<body>
    ...
    <p class = "smallRight"><b>Hi, <?php echo htmlspecialchars($_SESSION["email_c"]);?> </p>
    ...
    $sql = "SELECT * FROM customer_info WHERE email_c = '".$email."'";
    ...
    <center>
    <p class = "centertext"><a href="customerupdateinfo.php">Update Information.</a></p>
    <p class = "centertext"><a href="customerviewappointments.php">View Current Appointments.</a></p>
    <p class = "centertext"><a href="customerhomepage.php">Go back to the homepage.</a></p>
    </center>
